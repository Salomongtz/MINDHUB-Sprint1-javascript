...
export function createCardTemplate(movie) {
    ...
    return `
    <article class="art hover:visible md:hover:h-auto md:h-96 w-64 p-4 text-ellipsis card bg-black text-white flex flex-col rounded-2xl justify-between">
    <img class="rounded-md" src="https://moviestack.onrender.com/static/${movie.image}" alt="image">
    <svg data-id="${movie.id}" fill="${color}" class="botoncito p-1.5 bg-gray-300 absolute invisible hover:visible hover:bg-gray-400 font-bold h-8 w-8 rounded-full inline-flex justify-center items-center favbtn" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path data-id="${movie.id}" d="M12 4.435c-1.989-5.399-12-4.597-12 3.568 0 4.068 3.06 9.481 12 14.997 8.94-5.516 12-10.929 12-14.997 0-8.118-10-8.999-12-3.568z"/></svg>
